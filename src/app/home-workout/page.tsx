        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-500 max-w-2xl mx-auto">
              AI-powered workout plans designed specifically for home environments. 
              Maximize your time with bodyweight-based training.
            </p>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { name: "Push-ups", muscle: "Chest", sets: "4x8-10" },
              { name: "Squat", muscle: "Legs", sets: "4x6-8" },
              { name: "Glute Bridge", muscle: "Back", sets: "3x5" },
              { name: "Pike Push-ups", muscle: "Shoulders", sets: "3x10" },
              { name: "Superman", muscle: "Back", sets: "3x12" },
              { name: "Lunges", muscle: "Legs", sets: "3x12" },
            ].map((exercise, i) => (
            ...
            {[
              {
                ...
                a: "Yes, these workouts are designed for home environments with access to barbells, dumbbells, and machines.",
              },
              {
