        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gray-100 text-sm font-medium text-gray-600 mb-6">
              ...
              <span>Beginner Workout</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-black mb-4">
              Beginner Workout Generator
            </h1>
            <p className="text-lg text-gray-500 max-w-2xl mx-auto">
              AI-powered workout plans designed specifically for any environment. 
              Maximize your time with beginner-friendly training.
            </p>
          </div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-bold text-black mb-3">
              Generate Your Beginner Plan
            </h2>
            <p className="text-gray-500">
              Tell us your goals and we&apos;ll create a plan using gym equipment.
            </p>
          </div>
          <WorkoutForm onPlanGenerated={setPlan} defaultEquipment="bodyweight" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="text-2xl font-bold text-black mb-8 text-center">
            Popular Beginner Exercises
          </h2>
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { name: "Wall Push-ups", muscle: "Chest", sets: "4x8-10" },
              { name: "Chair Squats", muscle: "Legs", sets: "4x6-8" },
              { name: "Bird Dog", muscle: "Back", sets: "3x5" },
              { name: "Arm Circles", muscle: "Shoulders", sets: "3x10" },
              { name: "Back Extensions", muscle: "Back", sets: "3x12" },
              { name: "Step-ups", muscle: "Legs", sets: "3x12" },
            ].map((exercise, i) => (
            ...
            {[
              {
                ...
                a: "Yes, these workouts are designed for any environment with access to barbells, dumbbells, and machines.",
              },
              {
