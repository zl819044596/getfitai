...
export const metadata: Metadata = {
  ...
  description:
    "Generate personalized workout plans with AI. Choose your goal, experience level, and equipment. Get a custom training plan in seconds. Sign in to save your plans.",
  alternates: {
