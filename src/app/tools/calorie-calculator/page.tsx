...
export const metadata: Metadata = {
  ...
  description:
    "Calculate your daily calorie needs for free. Get your BMR, TDEE, and personalized calorie target based on your activity level. Sign in to save your plans.",
  alternates: {
...
export default function CalorieCalculatorPage() {
  const breadcrumb = breadcrumbList([
    ...
    { name: "Calorie Calculator", url: "https://www.getfitai.io/tools/calorie-calculator/" },
  ]);
