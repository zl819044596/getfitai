      ...
      <section className="pt-32 pb-16 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-gray-500">Last updated: May 20, 2025</p>
          </div>
          ...
          <div className="prose prose-neutral max-w-none">
            ...
            <h2 className="text-xl font-bold text-black mt-8 mb-4">3. Data Storage</h2>
            ...
            <h2 className="text-xl font-bold text-black mt-8 mb-4">5. Cookies</h2>
            <p className="text-gray-600 mb-6">
              We use minimal cookies for analytics purposes. You can disable cookies in your browser settings.
            </p>

            <h2 className="text-xl font-bold text-black mt-8 mb-4">6. Your Rights</h2>
            <p className="text-gray-600 mb-6">
